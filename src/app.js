...
import { studentRouter as meetingStudentRouter, profRouter as meetingProfRouter, meetingsRouter } from "./modules/cohort-meetings/cohort-meetings-routes.js";
...
import studentResearchRoutes from "./modules/research/student-research-routes.js";
...
// Meetings — teen alag mount points, mergeParams:true se cohortId milega
app.use("/api/v1/cohort/:cohortId/student",   meetingStudentRouter);
app.use("/api/v1/cohort/:cohortId/prof",      meetingProfRouter);
app.use("/api/v1/cohort/:cohortId/meetings",  meetingsRouter);

// ── Attendance ────────────────────────────────────────────────────────────────
// /api/v1/attendance/logs/:cohortId, /api/v1/professor/logs, /api/v1/courses/:courseId/attendance
